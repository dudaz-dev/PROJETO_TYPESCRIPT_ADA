...
do {
    ...
    switch (opcao) {
        case 1:
            ...
            const livro = new Livro(tituloLivro, anoLivro, autor, editora, localizacaoLivro, isbn);
        ...
        case 3:
            ...
            const dvd = new DVD(tituloDVD, anoDVD, duracaoDVD, diretor, localizacaoDVD);
        ...
        case 4:
            ...
            const revista = new Revista(tituloRevista, anoRevista, autorRevista, editoraRevista, edicaoRevista, localizacaoRevista);
